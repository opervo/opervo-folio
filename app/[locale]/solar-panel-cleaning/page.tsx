...
export const metadata: Metadata = {
  ...
  description: 'Solar panel cleaning software, residential and commercial. Recurring agreements auto-bill, route planning, before/after panel photos to your folio. $24.99/mo.',
