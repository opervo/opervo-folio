...
const config: TradePageConfig = {
  ...
  faqs: [
    ...
    { q: 'Does it work on iPhone? Is there an app?', a: 'Yes, Opervo is on the App Store and Google Play, and the same login works on any browser too. Updates push to your phone automatically, no waiting on App Store review when we ship a fix.' },
