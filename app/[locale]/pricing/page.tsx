...
export const metadata: Metadata = {
  ...
  description: 'Simple, transparent pricing. Solo $24.99/mo, Team $54.99/mo. Every feature included, no per-user fees. 14-day free trial, no credit card required.',
          ...
          <div style={{ flex: '1 1 380px', minWidth: 0, position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ maxWidth: 320 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', fontFamily: "'Barlow Condensed', sans-serif", textTransform: 'uppercase', letterSpacing: '0.06em', fontSize: 11, fontWeight: 800, marginBottom: 6 }}>
                <span style={{ color: '#F7F5F2' }}>45 of 50 claimed</span>
                <span style={{ color: '#F5620F' }}>5 remaining</span>
              </div>
              <div style={{ position: 'relative', height: 6, background: 'rgba(255,255,255,0.08)', borderRadius: 999, overflow: 'hidden' }}>
                <div style={{ position: 'absolute', top: 0, left: 0, height: '100%', width: '90%', background: 'linear-gradient(90deg, #F5620F 0%, #FF8A3D 100%)', borderRadius: 999, boxShadow: '0 0 10px rgba(245,98,15,0.5)' }} />
              </div>
            </div>
          </div>
