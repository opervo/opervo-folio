...
export const metadata: Metadata = {
  title: 'Window Cleaning Software for Solo Operators | Opervo',
  description: 'Window cleaning software for solo operators. Recurring agreements auto-bill, before/after photos to your folio, route optimization. $24.99/mo, 14-day trial.',
...
const config: TradePageConfig = {
  ...
  faqs: [
    ...
    { q: 'Does it work on iPhone?', a: 'Yes, Opervo is on the App Store and Google Play, and the same login works on any browser too. Updates push to your phone within 24 hours. No App Store delays when we ship a fix.' },
  ],
