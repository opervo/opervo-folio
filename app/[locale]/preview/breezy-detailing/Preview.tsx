...
// not "here's a generic dark-orange Opervo template."

const CARBON = '#0a0a0c'
const INK_SOFT = '#1a1b1f'
const BLUE = '#0091ea'
const BLUE_BRIGHT = '#00b0ff'
const CHROME = '#c8ccd1'
const INK = '#0a0a0a'
const MUTED = '#5f6368'
const LINE = '#e5e2dc'
...
// Iframe src for the live Breezy site. Default: the Vercel interim
// deploy. Swap to Ricardo's real domain when his hosting is up.
// Override per-env via NEXT_PUBLIC_BREEZY_DETAILING_URL.
const BREEZY_URL =
  process.env.NEXT_PUBLIC_BREEZY_DETAILING_URL ||
  'https://breezy-detailing.vercel.app'
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <span style={{ color: 'rgba(255,255,255,0.85)' }}>
            Breezy Detailing · Auto Detailing, DFW
          </span>
        </div>
        <Link
          href="/sites"
      ...
      <section style={{ padding: '56px 24px 24px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            Built for a premium auto detailer in DFW. Same approach for any
            home service trade. Scroll the live site below.
          </p>
      ...
      <section style={{ padding: '16px 24px 32px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <BrowserFrame domain="breezydetailing.com">
          ...
          >
            <span>
              Live site, embedded. Scroll inside the frame to walk through
              every section.
            </span>
            <a
              href={BREEZY_URL}
        ...
        >
          <div
            ...
            style={{
              ...
              inset: 0,
              background:
                'radial-gradient(40% 60% at 100% 0%, rgba(0,176,255,0.35), transparent 60%), radial-gradient(40% 60% at 0% 100%, rgba(0,0,0,0.35), transparent 60%)',
            }}
          />
          <span
            style={{
          ...
          >
            30-day delivery. Custom domain included. Cancel anytime. Same
            level of polish you just scrolled through, dialed to your trade
            and your brand.
          </p>
          <div
            style={{
          ...
          >
            ...
            <Link
              ...
              style={{
                ...
                alignItems: 'center',
                gap: 8,
                boxShadow: '0 10px 24px -10px rgba(0,176,255,0.5)',
              }}
            >
              Start a build
              <ArrowGlyph color={CARBON} />
  ...
  return (
    <div
      style={{
        ...
        borderRadius: 14,
        boxShadow:
          '0 30px 80px -28px rgba(0,26,74,0.35), 0 10px 28px -10px rgba(0,0,0,0.12)',
        overflow: 'hidden',
...
function FeatureCard({ title, body }: { title: string; body: string }) {
  return (
    ...
    >
      ...
      <div style={{ fontSize: 16, fontWeight: 900, color: CARBON, marginTop: 14 }}>
        {title}
      </div>
      <div style={{ fontSize: 14, color: INK_SOFT, marginTop: 8, lineHeight: 1.55 }}>
        {body}
      </div>
    </div>
  )
