...
export default function CostCalculatorPage() {
  const [competitorId, setCompetitorId] = useState<CompetitorId>('markate')
  ...
  const cost = useMemo(() => computeCost(c, sel, teamSize), [c, sel, teamSize])

  const opervoPlan = pickOpervoPlan(teamSize)
