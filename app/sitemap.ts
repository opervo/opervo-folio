...
const entries: Entry[] = [
  ...
  { path: '/gutter-cleaning', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/roof-cleaning', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/holiday-lighting', changeFrequency: 'monthly', priority: 0.8 },
  ...
  { path: '/compare/opervo-vs-quoteiq', changeFrequency: 'monthly', priority: 0.7 },
  ...
  { path: '/blog/jobber-alternative-for-solo-operators', changeFrequency: 'monthly', priority: 0.6 },
