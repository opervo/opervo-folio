...
export const metadata: Metadata = {
  ...
  description: 'The #1 app for landscaping and lawn care businesses. Schedule mowing routes, send professional estimates, invoice clients, and showcase your work — all from your phone. $24.99/mo. Try free for 14 days.',
...
export default function Landscaping() {
  ...
  return (
    <div style={{ fontFamily: "'Barlow', sans-serif", background: '#F7F5F2', minHeight: '100vh', color: '#1a1a1a' }}>
      ...
      <OtherTrades exclude="/landscaping" />
